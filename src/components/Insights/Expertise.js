...
export class Expertise extends Component { 
    ...
    GetExpertise(){
        ...
        var self=this;
        Service.GetExpertise(self).then((response => {
            this.setState({
                expertisedata:response.result
            })
            ...
            <div id="content" class="tab-content w-100" role="tablist" style={{padding:"0px 4% "}}>
                 <div class="d-flex align-items-center justify-content-between mb-5">
                    <div class="fs-3 breadcrumb d-flex align-items-center  ">
                        ...
                        <span class="text-dark font-bold" style={{ fontSize: "28px" }}>Expertise</span>
                    </div>
                </div>
                <div class="card-body">
                <div class="row">
                   ...
                   <div class="col-lg-4 col-md-6 col-12">
                        <div class="border rounded p-4 mb-4">
                            <div class="font-bold mb-3 text-dark">Expertise Rank</div>
                            {this.state.expertisedata.length ?
                            this.state.expertisedata.map((data, index) => {
                                return (
                              <>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="Weekday">------ There is no expertise ------ </div>
                            </div>  
