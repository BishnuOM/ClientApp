...
export class RingRequestStatus extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: true,
    ...
    componentDidMount() {
        this.setState({
            isLoading: true,
        }, this.updateRingRequest)
    }

    updateRingRequest = debounce(function () {
        if (window.location.pathname) {
            ...
            this.setState({
                ...
                if (this.state.pathItems && this.state.pathItems.length == 4 && this.state.pathItems[2] && this.state.pathItems[3]) {
                    Service.UpdateRingRequest(this.state.pathItems[2], this.state.pathItems[3]).then((response) => {
                ...
                <div className='signup_background'>
                    ...
                    <div className='signup'>
                        <div className='temp'>
                            ...
                            <div className='temp1'>
                                <div class="fs-4 font-medium  text-dark" >Ring Request</div>
