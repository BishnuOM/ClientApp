...
(function() {
  ...
  MT('divWithclassNameAndId',
      '[punctuation div][punctuation&attribute (my-className#my-id)][punctuation . foo bar]');
  ...
  MT('phraseModifierAttributes',
      'p[attribute (my-className)]. This is a paragraph that has a className and' +
      ' this [em _][em&attribute (#special-phrase)][em emphasized phrase_]' +
      ' has an id.');

  MT('linkWithclassName',
      '[link "(my-className). This is a link with className":http://redcloth.org]');
  ...
  MT('inlineHtml',
      'I can use HTML directly in my [comment <span className="youbetcha">Textile</span>].');
