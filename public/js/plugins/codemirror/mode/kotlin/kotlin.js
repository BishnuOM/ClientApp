...
CodeMirror.defineMode("kotlin", function (config, parserConfig) {
  ...
  var keywords = words(
          "package continue return object while break className data trait throw super" +
  ...
  var blockKeywords = words("catch className do else finally for if where try while enum");
